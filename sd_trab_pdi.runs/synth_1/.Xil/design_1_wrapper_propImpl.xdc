set_property SRC_FILE_INFO {cfile:/home/rf/sistemas_digitais/sd_trab_pdi_Operacoes/sd_trab_pdi.srcs/constrs_1/imports/ZYBO/ZYBO_Master.xdc rfile:../../../sd_trab_pdi.srcs/constrs_1/imports/ZYBO/ZYBO_Master.xdc id:1} [current_design]
set_property src_info {type:XDC file:1 line:9 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { clk_in }]; #IO_L11P_T1_SRCC_35 Sch=sysclk
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { start}]; #IO_L7P_T1_34 Sch=BTN3
