...
HD_PWD='/home/rf/sistemas_digitais/sd_trab_pdi_Operacoes/sd_trab_pdi.runs/design_1_vga_driver_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vga_driver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vga_driver_0_0.tcl
